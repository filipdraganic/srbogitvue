...
<script>
    ...
    import BeogradNaVodi from "./beogradNaVodi";

	export default {
		name: "myGit",
		components: {BeogradNaVodi, MyGitTasks, MyGitRevisions, MyGitForks, MyGitIssues, MyGitFiles},
		created() {
